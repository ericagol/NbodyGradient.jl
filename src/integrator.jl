# The AH18 integrator and associated functions

"""

The AH18 integrator top level function. Carries out the AH18 mapping and computes the Jacobian.
"""
function ah18!(x::Array{T,2},v::Array{T,2},xerror::Array{T,2},verror::Array{T,2},h::T,m::Array{T,1},n::Int64,jac_step::Array{T,2},jac_error::Array{T,2},pair::Array{Bool,2},d::Derivatives{T}) where {T <: Real}
